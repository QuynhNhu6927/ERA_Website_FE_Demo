  ...
  return (
    <div className="bg-white shadow-sm pt-16 md:pt-20">
      <div className="overflow-hidden">
        <div className="flex items-center gap-1 sm:gap-2 md:gap-4 lg:gap-6 px-4 sm:px-8 lg:px-10 py-3 mx-auto max-w-6xl">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group relative pb-2 md:pb-3 px-0.5 sm:px-1 md:px-2 text-[11px] sm:text-xs md:text-sm font-medium transition-colors duration-200",
              ...
              >
                ...
                <span
                  className={cn(
                    "absolute bottom-0 left-0 right-0 h-0.5 transition-transform origin-left duration-200",
